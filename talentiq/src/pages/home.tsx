...
const Home = () => {
  ...
  return (
    <div className="flex flex-col bg-white min-h-screen">
      ...
      <div className="w-full pt-[80px] md:pt-[100px]" style={{ background: "linear-gradient(180deg, #D9E7F6, #FFFFFF)" }}>
        <div className="flex flex-col items-center">

          {/* ── HERO ── */}
          <section className="w-full max-w-7xl mx-auto px-4 sm:px-8 lg:px-[50px] py-12 md:py-20">
            <div className="flex flex-col lg:flex-row justify-between items-center gap-12 lg:gap-8">

              {/* Left */}
              <AnimSection direction="left" className="flex flex-col items-start w-full lg:max-w-[520px]">
                <button className="flex items-center bg-[#025CB84D] py-1 px-3 mb-4 gap-2 rounded-[30px] border-0">
                  <img src="https://storage.googleapis.com/tagjs-prod.appspot.com/v1/7UFjhTHX6R/z72i6j9m_expires_30_days.png" className="w-4 h-4 object-fill" alt="AI" />
                  <span className="text-[#00497D] text-sm">AI-Powered Career Intelligence</span>
                </button>

                <h1 className="text-black text-3xl sm:text-4xl lg:text-[40px] font-bold mb-4 leading-[1.3]">
                  Masa Depan Karir Anda,<br />Terukur dan Terarah.
                </h1>

                <p className="text-[#424752] text-base lg:text-lg mb-6 leading-8 max-w-[500px]">
                  TalentIQ AI menggunakan algoritma kecerdasan buatan tingkat lanjut untuk menganalisis
                  keahlian Anda, memetakan jalur karir yang optimal, dan menghubungkan Anda dengan
                  peluang kerja terbaik.
                </p>

                <button
                  className="flex items-center bg-[#025CB8] py-4 px-8 gap-3 rounded-xl border-0 hover:bg-[#0147A0] transition-colors duration-200"
                  style={{ boxShadow: "0px 2px 4px #0000001A" }}
                  onClick={() => navigate("/analisis-skill")}
                >
                  <span className="text-white text-base font-semibold">Mulai Sekarang</span>
                  <img src="https://storage.googleapis.com/tagjs-prod.appspot.com/v1/7UFjhTHX6R/4ramupsg_expires_30_days.png" className="w-4 h-4 rounded-xl object-fill" alt="Arrow" />
                </button>
              </AnimSection>
          ...
          <section className="w-full max-w-7xl mx-auto px-4 sm:px-8 lg:px-[50px] pb-16 md:pb-24">
            ...
            <AnimSection direction="up" delay={150}>
              <button
                className="flex flex-col items-center w-full bg-white py-16 sm:py-[81px] mx-auto rounded-[10px] border border-solid border-[#D9D9D9] hover:border-[#025CB8] transition-colors duration-300"
                style={{ boxShadow: "0px 4px 10px #00000080" }}
              >
                <img src="https://storage.googleapis.com/tagjs-prod.appspot.com/v1/7UFjhTHX6R/urvgnt1g_expires_30_days.png" className="w-16 sm:w-20 h-auto mb-10 sm:mb-[68px] object-fill" alt="CV" />
                <span className="text-[#424752] text-3xl sm:text-[50px] text-center px-4">Scan CV Anda</span>
              </button>
            </AnimSection>
          </section>
